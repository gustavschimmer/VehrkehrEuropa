...
lyr_Positronretina_0.setVisible(true);lyr_masterBoundary_1.setVisible(true);
var layersList = [lyr_Positronretina_0,lyr_masterBoundary_1];
...
lyr_masterBoundary_1.set('fieldImages', {'bbox_north': '', 'bbox_south': '', 'bbox_east': '', 'bbox_west': '', 'place_id': '', 'osm_type': '', 'osm_id': '', 'lat': '', 'lon': '', 'class': '', 'type': '', 'place_rank': '', 'importance': '', 'addresstype': '', 'name': '', 'display_name': '', 'Measures': '', 'Status': '', });
